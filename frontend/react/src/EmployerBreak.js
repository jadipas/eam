...
class EmployerBreak extends React.Component {
  constructor(props) {
    super(props)
  ...
  sendReq = (e) => {
    ...
    if(this.props.role!=='employer'){
        this.setState({
            err: <p>Παρακαλώ συνδεθείτε ως εργοδότης. Αν είστε εγγεγραμμένος ως Εργαζόμενος <Link to="/Employees/EmployeesCOVID/EmployeesCOVIDAdeies/EmployeeBreak">πάτε στην αντίστοιχη σελίδα</Link> </p>
          })
        document.getElementById("errmsg").style.opacity = "1"; 
        return;
    }
      ...
      return (
        ...
        <div className="wrapper row3">
            <main className="hoc container clear"> 
                <h1><u>Δήλωση Αναστολής Εργασίας Εργαζομένων</u></h1>
                <form>
